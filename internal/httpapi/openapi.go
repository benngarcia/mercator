...
const OpenAPIJSON = `{
  ...
  "components": {
    ...
    "schemas": {
      ...
      "ConnectionFailure": {"type": "object", "required": ["connection_id", "adapter_type", "message"], "properties": {"connection_id": {"type": "string"}, "adapter_type": {"type": "string"}, "message": {"type": "string"}}},
      "OfferListResponse": {"type": "object", "required": ["offers", "failures"], "properties": {"offers": {"type": "array", "items": {"type": "object"}}, "failures": {"type": "array", "items": {"$ref": "#/components/schemas/ConnectionFailure"}}}},
