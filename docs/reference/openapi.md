...
| Connections and offers | `GET /v1/connections`, `GET /v1/offers` | Inspect configured provider connections and the offers visible to the placement engine for a workspace. |
