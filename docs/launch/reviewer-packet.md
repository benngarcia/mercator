...
| Are safe starter tasks available? | Public `good first issue` and `help wanted` queues, issue templates | First issues are bounded away from unsafe lifecycle/auth changes. |
