...
- After `v1.0.0`, public HTTP and CLI compatibility should follow SemVer.
...
- Documentation updates in the root README, OpenAPI text, CLI reference, or
  production docs.
...
Prefer adding a new field, route, or flag and documenting old behavior as
